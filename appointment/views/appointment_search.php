	...
	<div class="container" style="width:99%;">
		...
		<?php echo Modules::run('leftmenu/appointment'); //runs the available left menu for preferance ?>
			...
			<div class="panel panel-default"  >
                ...
                <b>Appointments/Tokens
				</b></div>
                <form method="POST" action="<?php echo site_url("qdisplay/make_serverd"); ?>">
                <span style="color:red;">Make tokens below <input type="text" name="max_token" style="width:50px;"> as served.
                <input class="btn btn-default btn-sm" type="submit" value ="GO" >
                <a class="btn btn-default btn-sm pull-right" href="<?php echo site_url("qdisplay/skip_tokens"); ?>">Skip all called patient</a>
                </span>
                </form>
...
<script>
//<input type="text" name="app_date" id="app_date" value="2014-07-07" style="border:0px;cursor:pointer;" class="hasDatepicker">
</script>
